...
class TestGrafo(unittest.TestCase):
    ...
    def test_euleriano(self):
        ...
        self.assertEqual(set(self.g_euler6.exibirCaminho()), set(['1', 'a1', '2', 'a2', '3', 'a3', '4', 'a4', '2', 'a5', '5', 'a6', '1']))
        self.assertEqual(set(self.g_euler7.exibirCaminho()), set(['1', 'a1', '2', 'a2', '3', 'a3', '4', 'a4', '5', 'a5', '1']))
        self.assertEqual(set(self.g_euler8.exibirCaminho()), set(['1', 'a1', '3', 'a2', '4', 'a3', '2', 'a5', '3', 'a4', '5', 'a7', '4', 'a6', '1']))
        self.assertEqual(set(self.g_euler9.exibirCaminho()), set(['1', 'a1', '2', 'a2', '3', 'a3', '4', 'a4', '5', 'a5', '1', 'a6', '4', 'a9', '2', 'a8', '5', 'a10', '3', 'a7', '1']))
        self.assertEqual(set(self.g_euler10.exibirCaminho()), set(['1', 'a1', '2', 'a2', '6', 'a3', '5', 'a4', '4', 'a6', '3', 'a5', '2', 'a8', '4', 'a7', '1']))
        self.assertEqual(set(self.g_euler11.exibirCaminho()), set(['1', 'a1', '2', 'a2', '5', 'a3', '3', 'a4', '4', 'a5', '5', 'a6', '6', 'a7', '1']))
        self.assertEqual(set(self.g_euler12.exibirCaminho()), set(['1', 'a1', '2', 'a2', '3', 'a3', '4', 'a4', '5', 'a8', '6', 'a5', '2', 'a6', '4', 'a7', '6', 'a9', '1']))    
        self.assertEqual(set(self.g_euler13.exibirCaminho()), set(['4', 'a3', '1', 'a1', '2', 'a5', '3', 'a2', '1', 'a4', '6', 'a8', '5', 'a6', '2', 'a7', '7', 'a9', '6']))    
